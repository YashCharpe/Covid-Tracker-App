...
public class SlotAdapter extends RecyclerView.Adapter<SlotAdapter.SlotViewHolder> {
    ...
    public static class SlotViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public SlotViewHolder(@NonNull @NotNull View itemView) {
            super(itemView);
    ...
    @NotNull
    @Override
    public SlotViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.slot_item,parent,false);
        SlotViewHolder svh = new SlotViewHolder(v);
        return svh;
    }
