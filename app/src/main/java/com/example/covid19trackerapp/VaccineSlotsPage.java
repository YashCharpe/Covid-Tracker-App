...
public class VaccineSlotsPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int pinCode = Integer.parseInt(bundle.getString("pincode"));
        ...
        Log.d("ID Date", "ID: "+district_id+ " Date: "+date+" Pincode: "+pinCode);
        ...
        if(pinCode==0)
        {
            ...
            Call<VaccineSessionModel> call = covidAPI.getVaccineSlotsByPinCode(pinCode,date);
